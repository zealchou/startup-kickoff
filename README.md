<p align="center">
  <img src="assets/cover.svg" alt="Startup Kickoff" width="100%">
</p>

<h1 align="center">Startup Kickoff・創業點子死亡行軍</h1>

<p align="center">
  <b>An idea walks in. Evidence walks out. Most of the idea will not survive —
  and that is the product.</b>
  <br>
  <i>一個點子走進來，只有證據能走出去。這個點子的大部分都活不下來——而這正是這個
  產品的價值所在。</i>
</p>

<p align="center">
  <a href="LICENSE"><img alt="License: MIT" src="https://img.shields.io/badge/license-MIT-blue?style=flat"></a>
  <img alt="Claude Skill" src="https://img.shields.io/badge/Claude-Skill-orange?style=flat">
  <img alt="version v0.2" src="https://img.shields.io/badge/version-v0.2-informational?style=flat">
  <img alt="EN / 繁中" src="https://img.shields.io/badge/EN%20%2F%20%E7%B9%81%E4%B8%AD-lightgrey?style=flat">
  <img alt="PRs welcome" src="https://img.shields.io/badge/PRs-welcome-brightgreen?style=flat">
</p>

<p align="center">
  <b>⚔️ 12 gates · 4 rings · ☠️ Survival Index · 🪦 Autopsy Card · ♻️ The Reforge</b>
  <br>
  <i>⚔️ 12 道關卡・4 個環・☠️ 存活指數・🪦 死亡診斷卡・♻️ 重鑄</i>
</p>

<p align="center">
  <a href="#what-it-does">What it does</a> •
  <a href="#the-gauntlet">The gauntlet</a> •
  <a href="#why-trust-the-number">Why trust the number</a> •
  <a href="#install-use">Install &amp; use</a> •
  <a href="#philosophy">Philosophy</a>
</p>

> 📖 English first, Traditional Chinese follows — every section is paired. 本文件採「一段英文、一段中文」對照。
...
<sub>fictional demo run — full transcript in <code>examples/</code><br>
虛構示範，完整過程見 <code>examples/</code></sub>
...
- [What it does / 這是什麼](#what-it-does)
- [The Gauntlet at a glance / 關卡一覽](#the-gauntlet)
- [Why trust the number / 這個數字憑什麼可信](#why-trust-the-number)
- [Install & use / 安裝與使用](#install-use)
- [What's in the box / 內容物](#whats-in-the-box)
- [Philosophy / 設計哲學](#philosophy)
- [Share your card / 分享你的診斷卡](#share-your-card)
- [Changelog / 更新紀錄](#changelog)
- [License / 授權](#license)
...
<a id="why-trust-the-number"></a>

## Why trust the number / 這個數字憑什麼可信
...
**Claude Code:** copy this whole folder to `~/.claude/skills/startup-kickoff/`
(keep the folder name matching `startup-kickoff` so Claude Code discovers it
...
**Claude Code：** 把整個資料夾複製到 `~/.claude/skills/startup-kickoff/`（資料夾
名稱維持 `startup-kickoff`，Claude Code 才會照 `SKILL.md` frontmatter 的 `name:`
...
<a id="share-your-card"></a>

## Share your card / 分享你的診斷卡

Got an Autopsy Card or a Survival Certificate you're proud of (or terrified
by)? Screenshot it and share it — tag `#StartupKickoff` if you post it.

拿到一張讓你驕傲（或膽顫心驚）的死亡診斷卡或存活證書？截圖分享出去——如果你
貼出來，歡迎標 `#StartupKickoff`。
...
<details>
<summary><b>Changelog / 更新紀錄</b></summary>
